...
float quadRectangle::left() { return topLeft.x; }
float quadRectangle::right() { return topRight.x; }
float quadRectangle::top() { return topLeft.y; }
float quadRectangle::bottom() { return bottomLeft.y; }

// Returns true if the distance between the closest sides of this rect and rectToCompare is less than maxDistance
bool quadRectangle::withinDistance(quadRectangle rectToCompare, float maxDistance)
{
...
void quadRectangle::calculateVertices()
{
